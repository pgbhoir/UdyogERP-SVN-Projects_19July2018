...
namespace udBankMaster
{
    static class Program
    {
        ...
        static void Main(string[] args)
        {
            if (args.Length < 1)
            {
                //args = new string[] { "12", "U011920", "AIPLDTM024\\SQLExpress", "sa", "sa1985", "^21001", "ADMIN", @"D:\UdyogERP\Bmp\Icon_VudyogGST.ico", "UdyogERPSDK", "UdyogERPSDK", "1", "udpid6096DTM20110307112715", "ADMINISTRATOR", "Cheque Management" };
