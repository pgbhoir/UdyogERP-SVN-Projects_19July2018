PARAMETERS PCaption,PrintType,PrintCond,vform
****Versioning**** Added By Amrendra On 01/06/2011
	LOCAL _VerValidErr,_VerRetVal,_CurrVerVal
	_VerValidErr = ""
	_VerRetVal  = 'NO'
	TRY
		_VerRetVal = AppVerChk('VPRINT',GetFileVersion(),JUSTFNAME(SYS(16)))
...
DO FORM uefrmvouprint WITH PCaption,PrintType,PrintCond,vform
