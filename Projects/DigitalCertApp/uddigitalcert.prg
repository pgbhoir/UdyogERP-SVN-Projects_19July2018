Lparameters pPdfPath,pDept,pCat,pInv_sr,pEntry_ty,pDate,pMethod
...
_ShellExec = _ShellExec+" "+Alltrim(pApplCaption)+" "+Alltrim(pApplName)+" "+Alltrim(Str(pApplId))  +" "+Alltrim(pApplCode)+" "+Transform(pMethod)	&& Added by Sachin N. S. on 18/09/2015 for Bug-26664
