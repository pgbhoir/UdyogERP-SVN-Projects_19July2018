...
*!*		msqlstr = "select convert(varchar(max),convert(varchar(max),decryptbypassphrase(?usquarepass,newgroup))) as newgroup,newgroup as newgroup1 from r_status"	&&vasant16/11/2010a
