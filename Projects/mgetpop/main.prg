...
&& Added by Anil on 14082020 for Bug-33571 Start
mans = MESSAGEBOX("Vertical Search ",4+32,VuMess)
IF mans <> 6
	DO FORM frmsrchhorz WITH pFileNm,pCaption, pField,pReturn,PSearchV,pSplit,pxTraField,PxTraCaption,pSrchAny,objgpop,pTreeview TO mval  && Added by by Anil on 12082020
ELSE
	DO FORM frmsrchvert WITH pFileNm,pCaption, pField,pReturn,PSearchV,pSplit,pxTraField,PxTraCaption,pSrchAny,objgpop,pTreeview TO mval  && Added by by Anil on 12082020
ENDIF
&& Added by Anil on 14082020 for Bug-33571 End


*!*	DO FORM frmsrchhor WITH pFileNm,pCaption, pField,pReturn,PSearchV,pSplit,pxTraField,PxTraCaption,pSrchAny,objgpop,pTreeview TO mval  && Commented by Anil on 12082020


*Anil	DO FORM frmsrch WITH pFileNm,pCaption, pField,pReturn,PSearchV,pSplit,pxTraField,PxTraCaption,pSrchAny,objgpop,pTreeview TO mval 
