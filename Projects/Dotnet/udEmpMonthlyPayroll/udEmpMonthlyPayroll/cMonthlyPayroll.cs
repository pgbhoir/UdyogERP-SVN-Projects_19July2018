    ...
    static class cMonthlyPayroll
    {
        ...
        static int Main(string[] args)
        {
            if (args.Length < 3)
            {
                ...
                //args = new string[] { "113", "T091718", "AIPLDTM001\\SQLEXPRESS", "sa", "sa1985", "^14217", "ADMIN", @"D:\UdyogGST\Bmp\Icon_VudyogGST.ico", "UdyogGST", "UdyogGST.exe", "4764", "udPID4764DTM20111213125821", "opening" };
