...
namespace udTextShadeMaster
{
    public partial class frmMain : uBaseForm.FrmBaseForm
    {
        ...
        string vMainField = "Code", vTblMainNm = "Text_Shade_Master", vMainFldVal = "";
        ...
        public frmMain(string[] args)
        {
            ...
            InitializeComponent();
            this.pFrmCaption = "Shade Master"; //Rup
            this.pPApplPID = 0;
        ...
        private void btnCode_Click(object sender, EventArgs e)
        {
            ...
            //vSearchCol = "GradeName";  //Commented by Prajakta B. on 08/01/2020 for 33074
            vSearchCol = "Name";//Modified by Prajakta B. on 08/01/2020 for 33074
        ...
        private void BtnAddInfo_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlStr = "Select Head_Nm,Fld_Nm,Data_Ty,Fld_Wid=cast(Fld_Wid as int),fld_Dec=cast(fld_Dec as int),FiltCond From Lother Where e_Code='SH' Order By Serial";
