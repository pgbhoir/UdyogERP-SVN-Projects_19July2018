...
namespace udCountryMast
{
    public partial class frmMain : uBaseForm.FrmBaseForm
    {
        ...
        string vMainField = "country", vTblMainNm = "COUNTRY", vMainFldVal = "";
        ...
        public frmMain(string[] args)
        {
            ...
            InitializeComponent();
            this.pFrmCaption = "Country Master"; //Rup
            this.pPApplPID = 0;
        ...
        public void mthControlSet()
        {
            ...
            {
                this.btnCountryName.Image = Image.FromFile(fName);
        ...
        private void mthBindData()
        {
            ...
            this.txtCountryName.DataBindings.Add("Text", vTblMain, "country");
            this.txtCountryCode.DataBindings.Add("Text", vTblMain, "code");

        }

        private void mthBindClear()
        {
            this.txtCountryName.DataBindings.Clear();
            this.txtCountryCode.DataBindings.Clear();
        }
        ...
        private void mthEnableDisableFormControls()
        {
            ...
            {
                vEnabled = true;
                this.btnCountryName.Enabled = false;

            }
            else
            {
                this.btnCountryName.Enabled = true;
            ...
            //this.txtCountryName.Enabled = vEnabled;
            this.txtCountryCode.Enabled= vEnabled;
        ...
        private void mthChkNavigationButton()
        {
            ...
            if (this.pAddMode == false && this.pEditMode == false)
            {
                if (vTblMain.Rows.Count > 0)
                {
                    ...
                    SqlStr = "select country_id from " + vTblMainNm + " Where " + vMainField + ">'" + vMainFldVal + "'";
        ...
        private void mthSave()
        {
            ...
            this.mSaveCommandString(ref vSaveString, "#country_id#");
        ...
        private void mthChkSaveValidation(ref Boolean vValid)
        {
            ...
            if (string.IsNullOrEmpty(this.txtCountryName.Text.Trim()))
            {
                MessageBox.Show("Country Name Cannot be Blank", this.pPApplText, MessageBoxButtons.OK, MessageBoxIcon.Stop);
                vValid = false;
                this.txtCountryName.Focus();
                return;
            }
            ...
            if (string.IsNullOrEmpty(this.txtCountryCode.Text.Trim()))
            {
                MessageBox.Show("Country Code Cannot be Blank", this.pPApplText, MessageBoxButtons.OK, MessageBoxIcon.Stop);
                vValid = false;
            ...
            if (this.pAddMode)
            {
                ...
                SqlStr = "Select " + vMainField + " From " + vTblMainNm + " Where " + vMainField + "='" + this.txtCountryName.Text.Trim() + "'";
                DataTable tblValidation = new DataTable();
                tblValidation = oDataAccess.GetDataTable(SqlStr, null, 20);
                if (tblValidation.Rows.Count > 0)
                {
                    MessageBox.Show("Country Name Cannot be duplicate", this.pPApplText, MessageBoxButtons.OK, MessageBoxIcon.Stop);
                    vValid = false;
                    this.txtCountryName.Focus();
                }
            }
        ...
        private void mthDelete()
        {
                ...
                MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ...
                vDelString = "Delete from " + vTblMainNm + "  Where country_id=" + vTblMain.Rows[0]["country_id"].ToString();
        ...
        private void btnCountryName_Click(object sender, EventArgs e)
        {
            mcheckCallingApplication();
            string VForText = string.Empty, vSearchCol = string.Empty, strSQL = string.Empty, Vstr = string.Empty, vColExclude = string.Empty, vDisplayColumnList = string.Empty, vReturnCol = string.Empty;
            DataSet tDs = new DataSet();
            SqlStr = "select country,code from " + vTblMainNm + " order by " + vMainField;
            ...
            vSearchCol = "country";
            vDisplayColumnList = "country:Country,code:Code";
            vReturnCol = "country";
            ...
            vMainFldVal = vTblMain.Rows[0]["country"].ToString().Trim();
            if (oSelectPop.pReturnArray != null)
            {
                this.txtCountryName.Text = oSelectPop.pReturnArray[0];
                vMainFldVal = this.txtCountryName.Text.Trim();
                SqlStr = "Select top 1 * from " + vTblMainNm + " Where " + vMainField + "='" + vMainFldVal + "' order by " + vMainField;
                vTblMain = oDataAccess.GetDataTable(SqlStr, null, 20);
