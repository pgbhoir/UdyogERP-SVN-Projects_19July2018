...
namespace udAttendanceApproval
{
    public partial class frmAttendanceIntegration : uBaseForm .FrmBaseForm
    {
        ...
        public frmAttendanceIntegration(string[] args)
        {
            ...
            this.pPara = args;
            this.pFrmCaption = "Day-to-Day Muster";
        ...
        private void loadLatestData()
        {
            ...
            {
                //SqlStr = "Select [ID],[Upload],[Approve],d.[EmployeeCode],[Day1],[Day2],[Day3],[Day4],[Day5],[Day6],[Day7],[Day8],[Day9],[Day10],[Day11]";
                //SqlStr = SqlStr + ",[Day12],[Day13],[Day14],[Day15],[Day16],[Day17],[Day18],[Day19],[Day20],[Day21],[Day22],[Day23],[Day24],[Day25]";
                //SqlStr = SqlStr + ",[Day26],[Day27],[Day28],[Day29],[Day30],[Day31],[Pay_Year],[Pay_Month],e.EmployeeName,e.supervisor";
                //SqlStr = SqlStr + " From Emp_daily_Muster d inner join employeemast e on d.employeeCode=e.employeeCode where Pay_Year='" + this.txtProcYear.Text.Trim() + "'";
                //SqlStr = SqlStr + " And Pay_Month='" + this.fnNMonth(this.txtProcMonth.Text.Trim()).ToString().Trim() + "'";
        ...
        private void ColumnBindToGrid()
        {
            ...
            dgrApprov.Columns.Add(txtWeekOff);
            ...
            dgrApprov.Columns.Add(txtHoliDay);
            ...
            if (tempx.Length > 0)
            {
                ...
                foreach (DataRow drAttSett in tempx)
                {
                    ...
                    txtLeave.Width = 110;
                    dgrApprov.Columns.Add(txtLeave);
                }
            }
        ...
        private void ControlsEnable()
        {
            ...
            else
            {
                ...
                {
                    btnPreview.Enabled = false; // Added By Pankaj B. on 29-04-2015 for Bug-25971
                }
                btnEdit.Enabled = true;
                btnSave.Enabled = false;
                btnNew.Enabled = false;
        ...
        private void mInsertProcessIdRecord()
        {
            ...
            cAppName = "udAttendanceApproval.exe";
        ...
        private void mthSaveString(ref string vSaveString, string tblTarget, DataRow dr)
        {
            ...
            else
            {
                ...
                for (int iCountx = 1; iCountx <= vMonthDays; iCountx++)
                {
                    vFld_Nm = "Day" + iCountx.ToString().Trim();
                    vSaveString = vSaveString + "," + vFld_Nm;
                    vSaveString = vSaveString + "='" + GetAttCode(dr[vFld_Nm].ToString()) + "'";
