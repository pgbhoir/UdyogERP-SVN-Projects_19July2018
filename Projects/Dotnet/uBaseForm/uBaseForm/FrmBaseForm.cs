...
namespace uBaseForm
{
    public partial class FrmBaseForm : Form
    {
        ...
        string[] vPara;
        DataSet vDataSet;
        Boolean vDisableCloseBtn, vCancelMode;
        public FrmBaseForm()
        {
            InitializeComponent();
        }
    ...
    #region  User Define Property
        ...
        public Boolean  pDisableCloseBtn
        {

            get
            {
                return vDisableCloseBtn;
            }
            set
            {
                vDisableCloseBtn = value;
            }
        }
        public Boolean pCancelMode  //Added by Pratap Bug-2128
        { 
            get
            {
                return vCancelMode;
