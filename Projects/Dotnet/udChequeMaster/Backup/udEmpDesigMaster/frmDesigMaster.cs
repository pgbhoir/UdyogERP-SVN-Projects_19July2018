...
{
    public partial class frmDesigMaster : uBaseForm.FrmBaseForm
    {

        DataAccess_Net.clsDataAccess oDataAccess;
        DataSet dsMain;
        string SqlStr = string.Empty;
        string vMainField = "DesNm", vMainTblNm = "Emp_Designation_Master", vMainFldVal = "";
        ...
        public frmDesigMaster(string[] args)
        {
            this.pDisableCloseBtn = true;  /* close disable  */
            InitializeComponent();
            this.pPApplPID = 0;
            this.pPara = args;
            this.pFrmCaption = "Designation Master";
        ...
        private void frmDesigMaster_Load(object sender, EventArgs e)
        {
            ...
            {
                this.btnDesigName.Image = Image.FromFile(fName);
            }
        }
        ...
        {
            this.txtDesigName.DataBindings.Clear();
        ...
        private void mthBindData()
        {
            ...
            this.txtDesigName.DataBindings.Add("Text", dsMain.Tables[0], "DesNm");
        ...
        private void mthEnableDisableFormControls()
        {
            ...
            {
                vEnabled = true;
                this.btnDesigName.Enabled = false;

            }
            else
            {
                this.btnDesigName.Enabled = true;

            }
            
            if (this.pAddMode)
            {
                this.txtDesigName.Enabled = true;
            }
            else
            {
        ...
        private void mthChkSaveValidation(ref Boolean vValid)
        {
            ...
            if (string.IsNullOrEmpty(this.txtDesigName.Text.Trim()))
            {
                MessageBox.Show("Designation Name Could not Blank", this.pPApplText, MessageBoxButtons.OK, MessageBoxIcon.Stop);
                vValid = false;
            }
        ...
        private void mthCancel(object sender, EventArgs e)
        {
            ...
            if (this.dsMain.Tables[0].Rows.Count == 1)
            {
                ...
                if (this.pEditMode)
                {
                    this.txtRemarks.Enabled = false; /*Ramya 07/02/12*/
                    vMainFldVal = dsMain.Tables[0].Rows[0][vMainField].ToString().Trim();
                    SqlStr = "Select top 1 * from " + vMainTblNm + " Where " + vMainField + "='" + vMainFldVal + "'";
                    dsMain = oDataAccess.GetDataSet(SqlStr, null, 20);
                    this.mthView();
        ...
        private void mthDelete()
        {
            ...
            SqlStr = "select distinct Designation from employeemast ";
        ...
        private void btnDesigName_Click(object sender, EventArgs e)
        {
            ...
            if (oSelectPop.pReturnArray != null)
            {
                ...
                vMainFldVal = this.txtDesigName.Text.Trim();
        ...
        private void txtDesigName_Validating(object sender, CancelEventArgs e)
        {
            ...
            DataSet dsData = new DataSet();
            string sqlstr;
            sqlstr = " select " + vMainField + " from " + vMainTblNm + " where " + vMainField + "='" + txtDesigName.Text.Trim() + "'";
            if (this.pEditMode)
            {
            ...
            if (dsData.Tables[0].Rows.Count > 0)
            {
                ...
                string ErrMsg = t.GetToolTip(txtDesigName).ToString();
                errorProvider.SetError(txtDesigName, "Duplicate " + lblDesig.Text + " value");
                txtDesigName.Focus();
                cValid = false; 
                e.Cancel = true;
                return;
            ...
            errorProvider.SetError(txtDesigName, "");
        }

        private void frmDesigMaster_FormClosed(object sender, FormClosedEventArgs e)  /*Ramya 210212*/
        {
