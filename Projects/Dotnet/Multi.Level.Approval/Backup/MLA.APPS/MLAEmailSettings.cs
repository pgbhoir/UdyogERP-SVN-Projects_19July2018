...
namespace MLA.APPS
{
    public partial class MLAEmailSettings : Form
    {
        ...
        public MLAEmailSettings(string connectionstring)
        {
            InitializeComponent();
            m_obj_cls_Gen_Mgr_Email_Settings = new cls_Gen_Mgr_Email_Settings(connectionstring);
        }
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MessageBox.Show("Entry Saved", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1);
                Close();
            }

            catch(Exception ex)
            {
                MessageBox.Show(ex.Message + " Entry cannot be Saved", "Error", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1);
                return;
            }
        }
