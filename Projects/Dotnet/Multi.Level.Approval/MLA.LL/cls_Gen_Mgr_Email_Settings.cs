...
namespace MLA.LL
{
    public class cls_Gen_Mgr_Email_Settings : cls_Gen_Ent_Email_Settings
    {
        ...
        public cls_Gen_Mgr_Email_Settings(string connectionstring)
        {
        ...
        public void Select()
        {
            try
            {
                ...
                m_DsSelect = cls_Sqlhelper.ExecuteDataset(sqlconn, CommandType.Text, "Select * From eMailSettings");
                DsSearch = m_DsSelect;
                m_DsSelect.Dispose();
