...
{
    public partial class frmIRN : uBaseForm.FrmBaseForm
    {
        ...
        public frmIRN()
        {
            ...
            InitializeComponent();
            this.pFrmCaption = "IRN Credential";
        }
        private void frmIRN_Load(object sender, EventArgs e)
        {
            this.mthControlSet();
            this.mthView();
            this.mthControlSet();
        ...
        {
            this.txtUserId.DataBindings.Add("Text", this.pTblMain, "IrnId");
            this.txtPassword.Text = VU_UDFS.NewDECRY(VU_UDFS.HexDecimalToASCII(this.pTblMain.Rows[0]["IrnPwd"].ToString().Trim()), "Ud*yog+1993NIC");
        }
        ...
        private void btnDone_Click(object sender, EventArgs e)
        {
            ...
            {
                this.pTblMain.Rows[0]["IrnPwd"] = VU_UDFS.ASCIIToHexDecimal(VU_UDFS.NewENCRY(this.txtPassword.Text.Trim(), "Ud*yog+1993NIC")).Substring(0,16);
            }
            Close();
        }
