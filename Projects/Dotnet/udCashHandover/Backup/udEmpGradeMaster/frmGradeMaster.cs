...
namespace udEmpGradeMaster
{
    public partial class frmGradeMaster : uBaseForm.FrmBaseForm
    {
        ...
        private void mthBindData()
        {
            ...
            this.txtGradeName.DataBindings.Add("Text", dsMain.Tables[0], "GradeNm");
        ...
        private void mthEnableDisableFormControls()
        {
            ...
            if (this.pAddMode)
            {
                this.txtGradeName.Enabled = true;
            }
            else
            {
        ...
        private void mthChkSaveValidation(ref Boolean vValid)
        {
            ...
            {
                MessageBox.Show("Grade Name Could not Blank", this.pPApplText, MessageBoxButtons.OK, MessageBoxIcon.Stop);
                vValid = false;
            }
            this.txtGradeName.Focus();
        ...
        private void btnGradeName_Click(object sender, EventArgs e)
        {
            ...
            DataSet tDs = new DataSet();
            SqlStr = "Select GradeNm,Remarks from " + vMainTblNm + " order by "+vMainField;
            tDs = oDataAccess.GetDataSet(SqlStr, null, 20);

            DataView dvw = tDs.Tables[0].DefaultView;

            VForText = "Select Grade Name";
            vSearchCol = "GradeNm";
            vDisplayColumnList = "GradeNm:Grade Name";
            vReturnCol = "GradeNm";
