...
namespace udclsDGVNumericColumn
{
    #region CNumEditDataGridViewEditingControl

    class CNumEditDataGridViewEditingControl : CNumEditBox, IDataGridViewEditingControl
    {
        ...
        public CNumEditDataGridViewEditingControl()
        {
    ...
    #region CNumEditDataGridViewColumn
    public class CNumEditDataGridViewColumn : DataGridViewTextBoxColumn
    {
        private const int m_allowMaxDecimalLength = 6;
        string vValidFunNm; //Rup 14/06/2013
        public CNumEditDataGridViewColumn()
        {
            CNumEditDataGridViewCell cell = new CNumEditDataGridViewCell();
        ...
        private CNumEditDataGridViewCell NumEditCellTemplate
        {
            get
            {
                CNumEditDataGridViewCell cell = this.CellTemplate as CNumEditDataGridViewCell;
                if (cell == null)
                {
                    throw new InvalidOperationException("CNumEditDataGridViewColumn does not have a CellTemplate.");
                }
                return cell;
            }
        }
        ...
        public override DataGridViewCell CellTemplate
        {
            ...
            set
            {
                CNumEditDataGridViewCell cell = value as CNumEditDataGridViewCell;
            ...
            set
            {
                ...
                if (this.DataGridView != null)
                {
                    ...
                    for (int rowIndex = 0; rowIndex < rowCount; rowIndex++)
                    {
                        ...
                        CNumEditDataGridViewCell dataGridViewCell = dataGridViewRow.Cells[this.Index] as CNumEditDataGridViewCell;
        ...
        public string pValidFunNm //Rup 14/06/2013
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("CNumEditDataGridViewColumn { Name=");
            sb.Append(this.Name);
            sb.Append(", Index=");
    ...
    #region CNumEditDataGridViewCell

    public class CNumEditDataGridViewCell : DataGridViewTextBoxCell
    {
        private bool m_showNullWhenZero = false;
        private bool m_allowNegative = true;
        private int m_decimalLength = 0;

        private static Type defaultEditType = typeof(CNumEditDataGridViewEditingControl);
        private static Type defaultValueType = typeof(System.Decimal);

        public CNumEditDataGridViewCell() { }
        ...
        private CNumEditDataGridViewEditingControl EditingCNumEditBox
        {
            get
            {
                return this.DataGridView.EditingControl as CNumEditDataGridViewEditingControl;
            }
        }
        ...
        {
            CNumEditDataGridViewCell dataGridViewCell = base.Clone() as CNumEditDataGridViewCell;
            if (dataGridViewCell != null)
            {
        ...
        public override void InitializeEditingControl(int rowIndex, object initialFormattedValue, DataGridViewCellStyle dataGridViewCellStyle)
        {
            ...
            CNumEditBox numEditBox = this.DataGridView.EditingControl as CNumEditBox;
            if (numEditBox != null)
            {
        ...
        public override void DetachEditingControl()
        {
            ...
            CNumEditBox numEditBox = dataGridView.EditingControl as CNumEditBox;
            if (numEditBox != null)
            {
        ...
        private bool OwnsEditingControl(int rowIndex)
        {
            ...
            CNumEditDataGridViewEditingControl editingControl = this.DataGridView.EditingControl as CNumEditDataGridViewEditingControl;
        ...
        internal void SetDecimalLength(int rowIndex, int value)
        {
            ...
            {
                this.EditingCNumEditBox.DecimalLength = value;
            }
        }
        ...
        internal void EnableNegative(int rowIndex, bool value)
        {
            ...
            if (OwnsEditingControl(rowIndex))
            {
                this.EditingCNumEditBox.AllowNegative = value;
            }
        }
        ...
        public override string ToString()
        {
            return "CNumEditDataGridViewCell { ColIndex=" + ColumnIndex.ToString(CultureInfo.CurrentCulture) +
