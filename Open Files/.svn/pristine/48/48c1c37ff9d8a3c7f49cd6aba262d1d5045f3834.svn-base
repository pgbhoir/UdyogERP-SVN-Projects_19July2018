If Exists(Select [name] From SysObjects Where xType='P' and [name]='Usp_Rep_RC_VOU')
Begin
	Drop Procedure Usp_Rep_RC_VOU
End
GO
...
Create PROCEDURE  [dbo].[Usp_Rep_RC_VOU] 
...
set @QueryString ='SELECT M.DATE,M.L_YN,I.GRO_AMT,M.TRAN_CD,I.ITSERIAL,I.ITEM,I.QTY,I.ITEM_NO,IT_MAST.RATEUNIT, IT_DESC=(CASE WHEN ISNULL(IT_MAST.IT_ALIAS,'''')='''' THEN IT_MAST.IT_NAME ELSE IT_MAST.IT_ALIAS END),  
MAILNAME=(CASE WHEN ISNULL(AC_MAST.MAILNAME,'''')='''' THEN AC_MAST.AC_NAME ELSE AC_MAST.MAILNAME END),  
AC_MAST.ADD1,AC_MAST.ADD2,AC_MAST.ADD3,M.U_LOAREF,I.U_ASSEAMT,M.U_LICNO,M.U_LICDATE,M.U_LICVALID,M.U_EXBAMT,M.U_FNO,M.U_FDATE  '
