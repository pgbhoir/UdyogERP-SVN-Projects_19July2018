If Exists(Select [name] From SysObjects Where xType='P' and [name]='Usp_Rep_ES_VOU')
Begin
	Drop Procedure Usp_Rep_ES_VOU
End
GO
...
-- DATE: 07/04/2020
-- DESCRIPTION:	THIS STORED PROCEDURE IS USEFUL TO GENERATE Excess stock Slip from Excess stock transaction.
-- REMARK:--Generated By Divyang P for Bug-33349
-- =============================================

Create PROCEDURE  [dbo].[Usp_Rep_ES_VOU] 
...
SET @SQLCOMMAND=''
SET @SQLCOMMAND = N''+@QueryString++''+N''+@Tot_flds+''+'  FROM ESMAIN M ' 
print @SQLCOMMAND
set @sqlcommand= @SQLCOMMAND +' 
 INNER JOIN ESITEM I ON (M.TRAN_CD=I.TRAN_CD) 
