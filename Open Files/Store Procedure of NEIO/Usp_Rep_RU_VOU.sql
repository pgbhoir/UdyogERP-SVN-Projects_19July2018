If Exists(Select [name] From SysObjects Where xType='P' and [name]='Usp_Rep_RU_VOU')
Begin
	Drop Procedure Usp_Rep_RU_VOU
End
GO
...
-- DATE: 07/04/2020
-- DESCRIPTION:	THIS STORED PROCEDURE IS USEFUL TO GENERATE Returnable Gate Pass Issue Slip from Returnable Gate Pass Issue transaction.
-- REMARK:--Generated By Divyang P for Bug-33349
-- =============================================

Create PROCEDURE  [dbo].[Usp_Rep_RU_VOU] 
