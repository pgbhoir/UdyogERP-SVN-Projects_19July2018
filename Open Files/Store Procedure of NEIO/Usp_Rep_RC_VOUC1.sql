If Exists(Select [name] From SysObjects Where xType='P' and [name]='Usp_Rep_RC_VOUC1')
Begin
	Drop Procedure Usp_Rep_RC_VOUC1
End
GO
...
Create PROCEDURE  [dbo].[Usp_Rep_RC_VOUC1] 
...
set @QueryString ='SELECT M.ENTRY_TY,M.DEPT,M.DATE,I.ITEM,I.QTY,M.TRAN_CD,M.INV_NO,I.ITSERIAL,I.L_YN,I.ITEM_NO,IT_MAST.P_UNIT,AC_MAST.MAILNAME,
AC_MAST.ADD1,AC_MAST.ADD2,AC_MAST.ADD3,I.U_LOASRNO,M.U_LOAREF,IT_DESC=(CASE WHEN ISNULL(IT_MAST.IT_ALIAS,'''')='''' THEN IT_MAST.IT_NAME ELSE IT_MAST.IT_ALIAS END),
MAILNAME=(CASE WHEN ISNULL(AC_MAST.MAILNAME,'''')='''' THEN AC_MAST.AC_NAME ELSE AC_MAST.MAILNAME END),AC_MAST.GSTIN,M.U_LICNO,M.U_LICVALID,M.BOND_NO,M.U_EXBDT,M.U_EXBAMT,M.U_EXBVALDT  '
