If Exists(Select [name] From SysObjects Where xType='P' and [name]='Usp_Rep_IR_VOU')
Begin
	Drop Procedure Usp_Rep_IR_VOU
End
GO
...
-- DATE: 07/04/2020
-- DESCRIPTION:	THIS STORED PROCEDURE IS USEFUL TO GENERATE Inter-Dept Receive Slip from Inter-Dept Receive transaction.
-- REMARK:--Generated By Divyang P for Bug-33349
-- =============================================

Create PROCEDURE  [dbo].[Usp_Rep_IR_VOU] 
...
set @sqlcommand= @SQLCOMMAND +' 
 INNER JOIN IRITEM I ON (M.TRAN_CD=I.TRAN_CD) 
