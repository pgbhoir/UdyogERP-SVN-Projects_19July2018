...
Into #tmpFlds 
From Lother Where e_code in ('P1') and DISP_MIS=1
union all
...
Where Entry_ty in ('P1') and DISP_MIS=1
...
Where Entry_ty='P1' and DISP_MIS=1
--Added by Divyang P on 18032020 for Bug-33349  End
...
,PTITEM.CGST_PER,PTITEM.SGST_PER,PTITEM.IGST_PER,PTITEM.CGST_AMT,PTITEM.SGST_AMT,PTITEM.IGST_AMT,PTMAIN.Tran_cd,PTMAIN.ENTRY_TY,PTITEM.U_ASSEAMT
...
SET @SQLCOMMAND=@SQLCOMMAND+'a.CGSTReceivable,a.GSTReceivable,a.IGSTReceivable,U_FREIGHT='''',a.LINERULE,PKGFRWD='''',CCESSRATE=case when a.CCESSRATE=''NO-CESS'' then '''' else a.CCESSRATE end ,a.COMPCESS,a.CESSReceivable ,'
SET @SQLCOMMAND=@SQLCOMMAND+'a.due_days,a.due_dt,a.EXPOTYPE,a.fcexrate '
SET @SQLCOMMAND = @SQLCOMMAND + N''+@Tot_flds+''+ ' from ##main11 a inner join PTMAIN on (PTMAIN.tran_cd=a.tran_cd and PTMAIN.ENTRY_TY=a.ENTRY_TY ) inner join PTITEM on (PTITEM.tran_cd=PTMAIN.tran_cd and PTMAIN.ENTRY_TY=PTITEM.ENTRY_TY) '		--Added by Divyang P on 18032020 for Bug-33349
