If Exists(Select [name] From SysObjects Where xType='P' and [name]='Usp_Rep_EQ_VOU')
Begin
	Drop Procedure Usp_Rep_EQ_VOU
End
GO
...
-- DATE: 07/04/2020
-- DESCRIPTION:	THIS STORED PROCEDURE IS USEFUL TO GENERATE Sales Enquiry Slip from Sales Enquiry transaction.
-- REMARK:--Generated By Divyang P for Bug-33349
-- =============================================

Create PROCEDURE  [dbo].[Usp_Rep_EQ_VOU] 
...
set @QueryString ='SELECT AC_MAST.AC_NAME,AC_MAST.ADD1,AC_MAST.ADD2,AC_MAST.ADD3,AC_MAST.CITY,AC_MAST.ZIP,M.INV_NO,M.DATE,M.GRO_AMT AS V_GRO_AMT,M.TOT_DEDUC,M.TOT_ADD,
M.TOT_TAX,M.TOT_NONTAX,M.NET_AMT,I.ITEM_NO,I.ITEM,I.QTY,I.RATE,I.GRO_AMT,IT_MAST.RATEUNIT,
IT_DESC=(CASE WHEN ISNULL(IT_MAST.IT_ALIAS,'''')='''' THEN IT_MAST.IT_NAME ELSE IT_MAST.IT_ALIAS END),MAILNAME=(CASE WHEN ISNULL(AC_MAST.MAILNAME,'''')='''' THEN AC_MAST.AC_NAME ELSE AC_MAST.MAILNAME END) '
...
set @sqlcommand= @SQLCOMMAND +' 
 INNER JOIN EQITEM I ON (M.TRAN_CD=I.TRAN_CD and m.entry_ty=i.entry_ty) 
