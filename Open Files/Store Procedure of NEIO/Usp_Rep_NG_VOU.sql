If Exists(Select [name] From SysObjects Where xType='P' and [name]='Usp_Rep_NG_VOU')
Begin
	Drop Procedure Usp_Rep_NG_VOU
End
GO
...
-- DATE: 07/04/2020
-- DESCRIPTION:	THIS STORED PROCEDURE IS USEFUL TO GENERATE Non-Returnable Gate Pass Issue Slip from Non-Returnable Gate Pass Issue transaction.
-- REMARK:--Generated By Divyang P for Bug-33349
-- =============================================

Create PROCEDURE  [dbo].[Usp_Rep_NG_VOU] 
...
set @QueryString ='SELECT M.INV_SR,M.ENTRY_TY,M.TRAN_CD,M.INV_NO,M.DATE,I.QTY,I.RATE,I.GRO_AMT,   IT_MAST.IT_NAME,IT_MAST.RATEUNIT,
 ...
 AC_NAME=CASE WHEN AC_MAST.MAILNAME='''' THEN AC_MAST.AC_NAME ELSE AC_MAST.MAILNAME END,    AC_MAST.ADD1, AC_MAST.ADD2,AC_MAST.ADD3, AC_MAST.STATE, AC_MAST.CITY, AC_MAST.ZIP,NARR=CAST(M.NARR AS VARCHAR(4000))  '
...
SET @SQLCOMMAND=''
SET @SQLCOMMAND = N''+@QueryString++''+N''+@Tot_flds+''+'  FROM IIMAIN M ' 
print @SQLCOMMAND
set @sqlcommand= @SQLCOMMAND +' 
 INNER JOIN IIITEM I ON (M.TRAN_CD=I.TRAN_CD) 
