If Exists(Select [name] From SysObjects Where xType='P' and [name]='Usp_Rep_R1_VOU')
Begin
	Drop Procedure Usp_Rep_R1_VOU
End
GO
...
-- DATE: 07/04/2020
-- DESCRIPTION:	THIS STORED PROCEDURE IS USEFUL TO GENERATE Labourjob Receive III Slip from Labourjob Receive III transaction.
-- REMARK:--Generated By Divyang P for Bug-33349
-- =============================================

Create PROCEDURE  [dbo].[Usp_Rep_R1_VOU] 
...
set @QueryString ='SELECT M.INV_NO,M.DATE,M.GRO_AMT AS V_GRO_AMT,M.NET_AMT,I.ITEM_NO,IT_MAST.IT_NAME,I.ITSERIAL,AC_MAST.AC_NAME,AC_MAST.ADD1,AC_MAST.ADD2,AC_MAST.ADD3
,AC_MAST.CITY,AC_MAST.STATE,AC_MAST.ZIP,NARR=CONVERT(VARCHAR(400),M.NARR ),I.QTY,I.RATE ,I.GRO_AMT,IT_MAST.RATEUNIT,IT_DESC=(RTRIM(IT_MAST.IT_NAME)+'' ''+IT_MAST.IT_ALIAS)
,MAILNAME=(CASE WHEN ISNULL(MAILNAME,'''')='''' THEN AC_NAME ELSE MAILNAME END),M.ENTRY_TY,M.TRAN_CD,IT_MAST.CHAPNO '
