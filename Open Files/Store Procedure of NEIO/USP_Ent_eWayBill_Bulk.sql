...
Begin
	...
	Begin
		...
		Print @SqlCommand
		Set @SqlCommand=@SqlCommand+' and  m.tran_cd Not in (select tran_cd from stitem  inner join it_mast on (it_mast.it_code=stitem.it_code) where it_mast.isservice=1 group by tran_cd having MAX(item_no)=count(item_no))'
	...
	Begin
		...
		Set @SqlCommand=@SqlCommand+' and m.Date Between '''+Convert(varchar(50),@Sdate)+''' and '''+Convert(varchar(50),@Edate)+''''
		Set @SqlCommand=@SqlCommand+' and  m.tran_cd Not in (select tran_cd from dcitem  inner join it_mast on (it_mast.it_code=dcitem.it_code) where it_mast.isservice=1 group by tran_cd having MAX(item_no)=count(item_no))'
		Print @SqlCommand
	...
	Begin
		...
		Set @SqlCommand=@SqlCommand+' and m.Date Between '''+Convert(varchar(50),@Sdate)+''' and '''+Convert(varchar(50),@Edate)+''''
		Set @SqlCommand=@SqlCommand+' and  m.tran_cd Not in (select tran_cd from ptitem  inner join it_mast on (it_mast.it_code=ptitem.it_code) where it_mast.isservice=1 group by tran_cd having MAX(item_no)=count(item_no))'
		Print @SqlCommand
		Execute Sp_ExecuteSql @SqlCommand	
	End
	...
	Begin
		...
		Set @SqlCommand=@SqlCommand+' and m.Date Between '''+Convert(varchar(50),@Sdate)+''' and '''+Convert(varchar(50),@Edate)+''''
		Set @SqlCommand=@SqlCommand+' and  m.tran_cd Not in (select tran_cd from ARitem  inner join it_mast on (it_mast.it_code=ARitem.it_code) where it_mast.isservice=1 group by tran_cd having MAX(item_no)=count(item_no))'
		Print @SqlCommand
		Execute Sp_ExecuteSql @SqlCommand	
	End
	...
	Begin
		...
		Set @SqlCommand=@SqlCommand+' and m.Date Between '''+Convert(varchar(50),@Sdate)+''' and '''+Convert(varchar(50),@Edate)+''''
		Set @SqlCommand=@SqlCommand+' and  m.tran_cd Not in (select tran_cd from iiitem  inner join it_mast on (it_mast.it_code=iiitem.it_code) where it_mast.isservice=1 group by tran_cd having MAX(item_no)=count(item_no))'
		Print @SqlCommand
		Execute Sp_ExecuteSql @SqlCommand	
	End
	...
	Begin
		...
		Set @SqlCommand=@SqlCommand+' and m.Date Between '''+Convert(varchar(50),@Sdate)+''' and '''+Convert(varchar(50),@Edate)+''''
		Set @SqlCommand=@SqlCommand+' and  m.tran_cd Not in (select tran_cd from iritem  inner join it_mast on (it_mast.it_code=iritem.it_code) where it_mast.isservice=1 group by tran_cd having MAX(item_no)=count(item_no))'
		Print @SqlCommand
		Execute Sp_ExecuteSql @SqlCommand	
	End
	...
	Begin
		...
		Set @SqlCommand=@SqlCommand+' and m.Date Between '''+Convert(varchar(50),@Sdate)+''' and '''+Convert(varchar(50),@Edate)+''''
		Set @SqlCommand=@SqlCommand+' and  m.tran_cd Not in (select tran_cd from cnitem  inner join it_mast on (it_mast.it_code=cnitem.it_code) where it_mast.isservice=1 group by tran_cd having MAX(item_no)=count(item_no))'
		Print @SqlCommand
		Execute Sp_ExecuteSql @SqlCommand	
	End
	...
	Begin
		...
		Set @SqlCommand=@SqlCommand+' and m.Date Between '''+Convert(varchar(50),@Sdate)+''' and '''+Convert(varchar(50),@Edate)+''''
		Set @SqlCommand=@SqlCommand+' and  m.tran_cd Not in (select tran_cd from sritem  inner join it_mast on (it_mast.it_code=sritem.it_code) where it_mast.isservice=1 group by tran_cd having MAX(item_no)=count(item_no))'
		Print @SqlCommand
		Execute Sp_ExecuteSql @SqlCommand	
	End
	...
	From #eWayBill Order By DocDt asc,DocNo asc
